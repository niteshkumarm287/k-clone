# Contributing to k-clone

## Project scope

Kubernetes job cloning CLI. Run zsh -n k-clone.zsh for syntax validation. Functional commands create Kubernetes jobs, so test only against an explicitly selected disposable cluster.
